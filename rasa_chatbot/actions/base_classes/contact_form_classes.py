"""
Validation mixins for form-specific reusable validation logic.
These mixins provide common validation methods that can be shared across multiple forms.
"""
from rasa_chatbot.actions.base_classes.base_classes import BaseFormValidationAction
