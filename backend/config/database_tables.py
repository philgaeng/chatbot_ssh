...
GRIEVANCE_CLASSIFICATION_STATUS_SEED_DATA = [
    {"code": "pending", "name": "Pending", "description": "Classification not started or LLM in progress"},
    {"code": "LLM_generated", "name": "LLM Generated", "description": "Summary and categories generated by LLM"},
    {"code": "LLM_failed", "name": "LLM Failed", "description": "LLM classification failed"},
    {"code": "LLM_skipped", "name": "LLM Skipped", "description": "Complainant skipped LLM classification; officer must classify"},
    {"code": "complainant_confirmed", "name": "Complainant Confirmed", "description": "Complainant confirmed summary and categories"},
    {"code": "officer_confirmed", "name": "Officer Confirmed", "description": "Officer confirmed summary and categories"},
    # Legacy — kept for FK/history; do not write on new rows
    {"code": "LLM_error", "name": "LLM Error", "description": "Deprecated — use LLM_failed"},
    {"code": "slot_skipped", "name": "slot_skipped", "description": "Deprecated — use LLM_skipped"},
    {"code": "REVIEWING", "name": "Reviewing", "description": "Deprecated — session-only while editing"},
]
