...
class TestGrievanceWorkflow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_complainant_id = db_manager.create_or_update_complainant()
        print(f"Test user ID: {self.test_complainant_id}")
        test_dict = {
            'complainant_id': self.test_complainant_id,
            'source': 'acc'
        }
        
        if not self.test_complainant_id:
            raise Exception("Failed to create test user")
        
        # Create grievance entry
        self.test_grievance_id = db_manager.create_or_update_grievance(
            test_dict
        )
        ...
        self.sample_files = {
            'complainant_address': 'complainant_address.webm',
            'complainant_village': 'complainant_village.webm',
            'complainant_municipality': 'complainant_municipality.webm',
            'complainant_phone': 'complainant_phone.webm',
            'complainant_full_name': 'complainant_full_name.webm',
            'grievance_description': 'grievance_description.webm'
        }
    ...
    #         'complainant_id': self.test_complainant_id,
    #         'grievance_description': 'Test grievance details',
    ...
    def test_complete_workflow(self):
        ...
        grievance_path = os.path.join(self.sample_dir, 'grievance_description.webm')
        print(f"Processing grievance file: {grievance_path}")
        
        # Initialize task chain
        task_chain = {
            'file_data': {
                'file_name': 'grievance_description.webm',
