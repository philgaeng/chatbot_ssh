...
_ASK_ACTIONS_BY_FORM_SLOT = {
    ...
    ("form_modify_contact", "complainant_municipality_confirmed"): "action_ask_complainant_municipality_confirmed",
    ("form_modify_contact", "complainant_village_temp"): "action_ask_modify_missing_field",
    ("form_modify_contact", "complainant_village_confirmed"): "action_ask_complainant_village_confirmed",
