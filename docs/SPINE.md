...
⚠ **`GRM-072` is the next free id.** (`GRM-067`, `GRM-068` and `GRM-069` were opened 2026-09-06 — the port measurement, the full-suite run it triggered, and the CI half of `GRM-068`'s fix; `GRM-070` and `GRM-071` were opened 2026-09-06 by QA-04a and QA-04b.)
