...
| **September 2026 — Operating model** | 📋 **Proposed — not approved** | [`2026-09_operating_model/`](2026-09_operating_model/) | OM-01…08: how work is **born, classified and gated** — five kinds, a four-question triage test, nine gates that all already exist, and six profiles derived from blast radius rather than from the label. Closes the gap that **three documents disagree about what is next** and a bug has no home. OM-01 (the standard, [`engineering/07_work_items.md`](../engineering/07_work_items.md)) has **landed**; its §11 lists every rule the repo does not yet satisfy and is the sprint's definition of done. ⚠ Q-01…Q-07 block OM-02/03; OM-04/05/06 can start today. Start at [`README.md`](2026-09_operating_model/README.md) |
