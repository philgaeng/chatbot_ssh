...
| **September 2026 — QA & build pipeline** | 📋 **Proposed — not approved** | [`2026-09_qa_automation/`](2026-09_qa_automation/) | QA-01…05: CI-built images (the 2026-09-04 deploy-OOM incident's own logged fix), stack isolation, a Playwright harness that can *look* at the officer UI, wired into CI. Closes HR-07's pending-human browser sweep and gives the portal its first end-to-end coverage. Design: [`DESIGN-qa-and-build-pipeline.md`](2026-09_qa_automation/DESIGN-qa-and-build-pipeline.md) |
