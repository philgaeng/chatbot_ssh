...
| **T-21-g** ✅ | The candidate shortlist loads, every shortlisted model states **why**, every excluded one states **a licence and a reason**, and nothing is in both lists — so a loosened consultant-Q7 is a data edit rather than a re-design | ✅ **Checked** — removed a reason → red |
