...
> **19 of 21 answered.** This file holds **only what is still live** — two open questions and one awaiting an
> external answer. The register below records every decision in one line each.
>
