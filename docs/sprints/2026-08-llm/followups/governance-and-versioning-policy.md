...
> **Blocked on:** the DPG consultant's answer to **Q-08-01**.
...
**Whether the DPGA requires either is itself the open question** (Q-08-01, in
[`docs/dpg/02_questions.md`](../../../dpg/02_questions.md)). Indicator 8 is
...
- [`../../../dpg/00_compliance_status.md`](../../../dpg/00_compliance_status.md) §8 (Q-08-01)
