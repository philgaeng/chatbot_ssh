...
> **Blocked on:** the DPG consultant's answer to **consultant-Q10**.
...
**Whether the DPGA requires either is itself the open question** (consultant-Q10, in
...
- [`../../../dpg/00_compliance_status.md`](../../../dpg/00_compliance_status.md) §3.4, §5 (consultant-Q10)
