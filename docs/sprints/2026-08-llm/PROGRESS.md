...
| P-07 | `load_dotenv('/home/ubuntu/nepal_chatbot/.env')` — an absolute EC2 path in a Docker-only stack. Dead code that reads as live config | `LLM_services.py:27` | DPG-11 |
