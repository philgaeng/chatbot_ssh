> **ARCHIVED (July 2026):** legacy pre-Docker-refactor doc (Rasa server, systemd, Flask, Twilio era). Superseded by the rewritten `docs/deployment/02_setup.md`. Kept for history only — do not follow.
