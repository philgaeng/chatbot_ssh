...
| 7 | ticketing | `translate_to_english` — `llm_client.py:150` | `gpt-4` | **Officer case notes**, verbatim |
| 8 | ticketing | `generate_case_findings`, `generate_resolved_case_summary_llm` — `llm_client.py:228, 307` | `gpt-4o-mini` (standard) / `gpt-4o` (SEAH) | **Whole case timeline**, including SEAH cases |
