...
print('\n=== Version Information ===')
print('python-socketio version:', pkg_resources.get_distribution('python-socketio').version)
print('python-engineio version:', pkg_resources.get_distribution('python-engineio').version)
print('===========================\n')
...
sio = socketio.Client(
    ...
    reconnection=False  # Disable reconnection for clearer error messages
)
...
def test_connection():
    ...
    try:
        ...
        server_url = 'wss://nepal-gms-chatbot.facets-ai.com'
