...
class Ticket(Base):
    ...
    current_overdue_episode_id: Mapped[str | None] = mapped_column(
        String(36),
        ForeignKey("ticketing.ticket_overdue_episodes.episode_id", ondelete="SET NULL"),
        nullable=True,
    )
    ...
    overdue_episodes: Mapped[list["TicketOverdueEpisode"]] = relationship(
        "TicketOverdueEpisode",
        back_populates="ticket",
        foreign_keys="TicketOverdueEpisode.ticket_id",
        order_by="TicketOverdueEpisode.started_at",
        lazy="select",
    )
    current_overdue_episode: Mapped["TicketOverdueEpisode | None"] = relationship(
        "TicketOverdueEpisode",
        foreign_keys=[current_overdue_episode_id],
        lazy="select",
    )
