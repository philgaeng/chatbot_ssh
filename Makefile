...
help:
	...
	@echo "  🔴 BLOCKED as of 2026-09-03: the next deploy WILL fail at the database."
	@echo "     integration/stage now carries the compose change POSTGRES_PASSWORD: \$${POSTGRES_PASSWORD:?},"
	@echo "     and this host's Postgres still holds the PRE-rotation credential (digest-verified 08-24)."
	@echo "     Migrate the host FIRST: docs/deployment/18_sops_migration_handover.md §5a."
	@echo "     ⚠ That procedure has a step with no undo, and 'make env-local' there deletes 30 vars."
